...
urlpatterns = [
    ...
    path('get-user/', UserLogin.as_view({'get': 'get', 'post': 'post'}), name="UserRegister-api-view"),
    path('get-user/<str:id>/', UserLogin.as_view({
        'get': 'retrieve',
        'put': 'update',
        'delete': 'destroy',
    })),
    path('get-shop/', ShopLogin.as_view({'get': 'get', 'post': 'post'}), name="ShopRegister-api-view"),
